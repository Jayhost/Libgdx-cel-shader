...
public class CelDepthShader extends DepthShader {
	...
	public static class Config extends DepthShader.Config {
		private static String defaultVertexShader = Gdx.files.internal("cel.depth.vertex.glsl").readString();
		private static String defaultFragmentShader = Gdx.files.internal("cel.depth.fragment.glsl").readString();
